...
<?php $__env->startSection('content'); ?>
    <div class="w3-row w3-section w3-center">
        ...
        <a href="<?php echo e(url('talents/approved')); ?>" class="w3-btn w3-round w3-light-blue w3-margin-left">Approved</a>
    </div>
    <div class="w3-row">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\talent\resources\views/welcome.blade.php ENDPATH**/ ?>