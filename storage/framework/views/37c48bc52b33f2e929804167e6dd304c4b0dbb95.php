...
<?php $__env->startSection('content'); ?>
    ...
    <div class="w3-row">
        ...
        <form action="<?php echo e(url('/talents')); ?>" method="POST" enctype="multipart/form-data">
           <?php echo csrf_field(); ?>
            <div class="w3-row">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\talent\resources\views/talents/create.blade.php ENDPATH**/ ?>